  ...
  if (fields) {
    ...
    return (
      ...
      >
        ...
        >
          <div className="promo-animated__image @md:order-2 @md:flex @md:w-full @md:justify-start">
            {image && (
              <div
                className={cn(
          ...
          <div className="promo-animated__content @md:order-1 @md:flex @md:w-full @md:flex-col @md:justify-center @md:items-start min-w-0">
            {showTitle && title && (
              <Text
                tag="h2"
