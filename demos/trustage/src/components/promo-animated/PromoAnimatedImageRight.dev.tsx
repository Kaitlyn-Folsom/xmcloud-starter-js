...
export const PromoAnimatedImageRight: React.FC<PromoAnimatedProps> = (props) => {
  ...
  if (fields) {
    ...
    return (
      <section ref={wrapperRef} data-component="PromoAnimated" className="@container bg-background px-4 py-10 md:py-14">
        <div
          data-class-change
          className={cn(
        ...
        >
          <div className="promo-animated__image @md:flex @md:order-2 @md:w-full @md:justify-start">
            {image && (
              <div
                className={cn(
          ...
          <div className="promo-animated__content @md:order-1 @md:flex @md:flex-col @md:justify-center @md:items-start min-w-0">
            {showTitleStack && (
              <div>
                {title && (
                  <Text
