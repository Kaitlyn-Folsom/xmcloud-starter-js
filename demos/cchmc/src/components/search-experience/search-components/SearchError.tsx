...
export const SearchError = ({ onTryAgain, error }: { onTryAgain: () => void; error: Error }) => {
  ...
  return (
    <div className="mb-8">
      <div className="bg-card border-destructive/30 rounded-none border p-12 text-center">
        <svg
          className="text-destructive mx-auto h-10 w-10"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        <div className="mt-6">
          <button
            onClick={onTryAgain}
            className="bg-destructive text-destructive-foreground cursor-pointer rounded-none px-4 py-2"
          >
