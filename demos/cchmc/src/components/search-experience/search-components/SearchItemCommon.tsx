...
export const ItemListFrame = ({ className, children, image, ...props }: ItemListFrameProps) => {
  return (
    <div
      className={cn(
        'bg-card border-border rounded-none border shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer md:h-57',
        className
      )}
      {...props}
    >
...
export const ItemCardFrame = ({ className, children, image, ...props }: ItemCardFrameProps) => {
  return (
    <div
      className={cn(
        'bg-card border-border rounded-none border shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer',
        className
      )}
      {...props}
    >
