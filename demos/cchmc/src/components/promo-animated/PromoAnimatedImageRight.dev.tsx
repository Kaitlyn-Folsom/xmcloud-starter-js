  ...
  if (fields) {
    ...
    return (
      <section data-component="PromoAnimated" className="@container">
        ...
        >
          {image && (
            <div className="promo-animated__image @md:absolute @md:inset-y-0 @md:left-0 @md:w-[68%] w-full">
          ...
          <PromoAnimatedContent
            ...
            contentClassName="@md:absolute @md:right-0 @md:top-1/2 @md:max-w-[min(520px,45%)] @md:-translate-y-1/2 @md:-mr-8 @xl:-mr-12 mt-6 @md:mt-0"
