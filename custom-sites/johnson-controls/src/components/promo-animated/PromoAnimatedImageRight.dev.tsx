    ...
    return (
      <>
        <style dangerouslySetInnerHTML={{ __html: `
          .promo-animated__image-gradient-left::before {
            content: '';
            position: absolute;
            z-index: 1;
        ...
        <section data-component="PromoAnimated" className="@container">
          ...
          >
            ...
            <div className="promo-animated__content @md:order-1 bg-white @md:flex @md:flex-col @md:justify-center @md:px-12 @lg:px-16 px-6 py-12 min-w-0">
            {title && (
          ...
          <div className="promo-animated__image promo-animated__image-gradient-left @md:order-2 relative w-full @md:h-full min-h-[400px] @md:min-h-[600px]">
            {image && (
