...
import * as ScrollParallaxProvider from 'src/components/non-sitecore/ScrollParallaxProvider';
...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['ScrollParallaxProvider', { ...ScrollParallaxProvider, componentType: 'client' }],
